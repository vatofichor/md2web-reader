    ...
    <div id="desktop-window" class="window-container">
        ...
        <div class="window-titlebar">
            ...
            <div class="titlebar-controls">
                <button class="titlebar-btn btn-minimize" aria-label="Minimize">_</button>
                <button class="titlebar-btn btn-maximize" aria-label="Maximize">square;</button>
                <button class="titlebar-btn btn-close" aria-label="Close">×</button>
            </div>
        </div>
        ...
        <footer class="window-statusbar">
            ...
            <div class="status-cell text-right" id="status-version">v1.0.0</div>
        </footer>
    </div>
